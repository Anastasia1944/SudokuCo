...
class OddEvenSudokuProcessor: GeneralSudokuProcessor {
    ...
    override func checkAll(sudokuOpenedNums: [[Int]], x: Int, y: Int, num: Int) -> Bool {
        ...
        checkOddEven(sudokuOpenedNums: sudokuOpenedNums, x: x, y: y, num: num)
    }
    
    func checkOddEven(sudokuOpenedNums: [[Int]], x: Int, y: Int, num: Int) -> Bool {
        return (gameState.sudokuNumbers[x][y] % 2 == 0) == (num % 2 == 0)
    }
